...
description: Generate architecture documentation for the Laravel application. Use when the user asks to create, update, or define the system architecture, technical organization, folder structure, class responsibilities, or architectural decisions (e.g., "defina a arquitetura", "crie os docs de arquitetura", "generate architecture"). This skill creates structured documentation in docs/architecture/ based on PRD requirements, code standards, and tech stack constraints.
---

# Architecture Documentation Generator

Generate comprehensive architecture documentation that defines the technical organization and structure of the Laravel application.
...
2. **Component Architecture** (`COMPONENTS.md`)
    ...
    - Extension points (custom modules, integrations)

3. **Data Flow** (`DATA_FLOW.md`)
    - Request lifecycle (incoming → auth → controller → response)
    - Service and Action execution flow
...
5. **Extension Architecture** (`EXTENSIONS.md`)
    - How to add custom modules or integrations
    - How to replace built-in services
